<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&text=engelhyunji&color=#FF69B4&text-color=8d5d76&height=100&fontSize=40" alt="header" />
      ...
      >
        <title id="titleId">Hwang Tae Young's GitHub Stats, Rank: B-</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2023 : 0, Total PRs: 71, Total Issues: 9, Contributed to (last year): 8</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 168.58370534722226;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Hwang Tae Young's GitHub Stats</text>
    </g>
      </g>
